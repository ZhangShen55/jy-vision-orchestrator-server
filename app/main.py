...
from app.infrastructure.worker_control import RedisWorkerControlStateRepository, WorkerDesiredState
from app.infrastructure.worker_registry import RedisWorkerRegistry
...
def run_single_json(config_path: str, message_json: str) -> None:
    from app.application.factories import build_worker
