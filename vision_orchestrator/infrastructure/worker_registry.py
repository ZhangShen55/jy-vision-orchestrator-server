...
from vision_orchestrator.infrastructure.compat import StrEnum
from vision_orchestrator.infrastructure.worker_control import WorkerDesiredState
...
class RedisWorkerRegistry:
    def __init__(
        ...
        try:
            ...
            raise RuntimeError("缺少 redis 依赖，请安装 vision_orchestrator/requirements.txt") from exc
